...
class Application:
    ...
    def _initialize_audio(self):
        ...
        try:
            ...
            from audio_codecs.audio_codec import AudioCodec
    ...
    def _initialize_wake_word_detector(self):
        ...
        try:
            from audio_processing.wake_word_detect import WakeWordDetector
    ...
    def _initialize_iot_devices(self):
        """初始化物联网设备."""
        from iot.thing_manager import ThingManager
        from iot.things.CameraVL.Camera import Camera

        # 导入新的倒计时器设备
        from iot.things.countdown_timer import CountdownTimer
        from iot.things.lamp import Lamp
        from iot.things.music_player import MusicPlayer
        ...
        if self.config.get_config("HOME_ASSISTANT.TOKEN"):
            ...
            from iot.things.ha_control import (
                HomeAssistantButton,
                HomeAssistantLight,
                HomeAssistantNumber,
                HomeAssistantSwitch,
