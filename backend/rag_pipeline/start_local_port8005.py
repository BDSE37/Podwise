#!/usr/bin/env python3
"""
Podwise RAG Pipeline 本地測試啟動腳本 (埠 8005)
"""
...
def start_application():
    ...
    logger.info("📖 API 文件: http://localhost:8005/docs")
    logger.info("🔍 健康檢查: http://localhost:8005/health")
...
def main():
    """主函數"""
    logger.info("🎯 開始 Podwise RAG Pipeline 本地測試 (埠 8005)")
