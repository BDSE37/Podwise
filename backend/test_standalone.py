...
"""
完全獨立的測試腳本
測試 MongoDB collection 處理功能，不依賴任何外部模組
"""
...
class SimpleErrorLogger:
    ...
    def __init__(self, log_file: str = "error_report.json"):
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        for error in self.errors:
            ...
            collections.add(error['collection_name'])
        
        return {
            'total_errors': len(self.errors),
            'error_types': error_types,
            'affected_collections': list(collections)
        }
...
class StandaloneCollectionProcessor:
    """獨立 Collection 處理器"""
    ...
    def __init__(self, 
        ...
        self.error_logger = SimpleErrorLogger()
...
def main():
    ...
    try:
        # 初始化處理器
        processor = StandaloneCollectionProcessor(
        ...
        # 輸出錯誤摘要
        error_summary = processor.error_logger.get_error_summary()
        logger.info(f"錯誤摘要: {error_summary}")
